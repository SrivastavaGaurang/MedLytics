          ...
          <>
            ...
            <div className="mb-3">
              ...
              <input
                ...
                max="100"
              />
              <small className="form-text text-muted">Range: 18-100 years</small>
            </div>
            ...
            <div className="row">
              <div className="col-md-6 mb-3">
                ...
                <input
                  ...
                  max="250"
                />
                <small className="form-text text-muted">Range: 100-250 cm</small>
              </div>
              ...
              <div className="col-md-6 mb-3">
                ...
                <input
                  ...
                  max="300"
                />
                <small className="form-text text-muted">Range: 30-300 kg</small>
              </div>
            </div>
            ...
            <div className="mb-3">
              ...
              <input
                ...
                readOnly
              />
              <small className="form-text text-muted">Healthy range: 18.5-24.9</small>
            </div>
          ...
          <>
            ...
            <div className="mb-3">
              ...
              <input
                ...
                step="0.5"
              />
              <small className="form-text text-muted">Range: 1-12 hours (Recommended: 7-9 hours)</small>
            </div>
            ...
            <div className="mb-3">
              ...
              <div className="d-flex align-items-center">
                <button 
                  ...
                  onClick={() => formData.qualityOfSleep > 1 && setFormData({...formData, qualityOfSleep: formData.qualityOfSleep - 1})}
                >
                  -
                </button>
                <input
                ...
                <button 
                  ...
                  onClick={() => formData.qualityOfSleep < 10 && setFormData({...formData, qualityOfSleep: formData.qualityOfSleep + 1})}
                >
                  +
                </button>
              </div>
          ...
          <>
            ...
            <div className="mb-3">
              ...
              <div className="d-flex align-items-center">
                <button 
                  type="button" 
                  className="btn btn-sm btn-outline-secondary me-2"
                  onClick={() => formData.physicalActivity > 0 && setFormData({...formData, physicalActivity: formData.physicalActivity - 5})}
                >
                  -
                </button>
                <input
                ...
                <button 
                  type="button" 
                  className="btn btn-sm btn-outline-secondary ms-2"
                  onClick={() => formData.physicalActivity < 100 && setFormData({...formData, physicalActivity: formData.physicalActivity + 5})}
                >
                  +
                </button>
              </div>
            ...
            <div className="mb-3">
              ...
              <div className="d-flex align-items-center">
                <button 
                  type="button" 
                  className="btn btn-sm btn-outline-secondary me-2"
                  onClick={() => formData.stressLevel > 1 && setFormData({...formData, stressLevel: formData.stressLevel - 1})}
                >
                  -
                </button>
                <input
                ...
                <button 
                  type="button" 
                  className="btn btn-sm btn-outline-secondary ms-2"
                  onClick={() => formData.stressLevel < 10 && setFormData({...formData, stressLevel: formData.stressLevel + 1})}
                >
                  +
                </button>
              </div>
            ...
            <div className="mb-3">
              ...
              <input
                ...
                max="30000"
              />
              <small className="form-text text-muted">Range: 100-30,000 steps (Recommended: 7,000-10,000)</small>
            </div>
          ...
          <>
            ...
            <div className="row mb-3">
              <div className="col-md-6">
                ...
                <input
                  ...
                  max="200"
                />
                <small className="form-text text-muted">Range: 70-200 mmHg (Normal: 90-120)</small>
              </div>
              <div className="col-md-6">
                ...
                <input
                  ...
                  max="120"
                />
                <small className="form-text text-muted">Range: 40-120 mmHg (Normal: 60-80)</small>
              </div>
            </div>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                max="200"
              />
              <small className="form-text text-muted">Range: 40-200 bpm (Normal: 60-100)</small>
            </div>
